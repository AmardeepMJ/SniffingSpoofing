...
int main(int argc, char **argv)
{
    ...
    // This is the code for Sniffing packets
    ...
    strcpy(data , "Spoofy SPoofy Spooofed Spooooooooof xD");
    ...
    sin.sin_addr.s_addr = inet_addr ("10.0.2.9");
    ...
    //For Sniffing USE BELOW CODE ALSO
